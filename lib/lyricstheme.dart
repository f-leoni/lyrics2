...
class LyricsTheme {
  ...
  static TextTheme darkerTextTheme = TextTheme(
    bodyLarge: GoogleFonts.lato(
        fontSize: 13, fontWeight: FontWeight.normal, color: Colors.white70),
    displayLarge: GoogleFonts.lato(
        fontSize: 28.0, fontWeight: FontWeight.bold, color: Colors.white70),
  ...
  static ThemeData light() {
    return ThemeData(
      ...
      primaryColorDark: Colors.black87, colorScheme: ColorScheme.fromSwatch(primarySwatch: Colors.lightBlue)
          .copyWith(secondary: Colors.lightBlue, brightness: Brightness.light).copyWith(background: Colors.blue.shade50),
    );
  }
  ...
  static ThemeData dark() {
    return ThemeData(
      ...
      primaryColorDark: Colors.white70, colorScheme: ColorScheme.fromSwatch(primarySwatch: Colors.green)
          .copyWith(secondary: Colors.greenAccent, brightness: Brightness.dark).copyWith(background: Colors.grey.shade800),
    );
  }
